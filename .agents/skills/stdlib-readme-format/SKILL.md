...
description: Authoritative format contract for `lib/stdlibs/ballerina/<name>/0.0.1/go1.27/README.md` files. Use when creating or updating any stdlib README, or when auditing an existing one for consistency.
---
